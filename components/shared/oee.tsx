      ...
      <div className="relative w-full h-full">
        <ResponsiveContainer width="100%" height={220}>
          <RadialBarChart
            ...
            barSize={24}
            data={data}
            startAngle={90} // Start angle for top-left
            endAngle={-270}
          >
            <RadialBar dataKey="value" />
          </RadialBarChart>
        </ResponsiveContainer>
        <div className="absolute w-full h-full flex justify-center items-center top-0 font-semibold text-xl">
          {oee.toFixed(2)}%
        </div>
      </div>
        ...
        <Dialog>
          ...
          <DialogContent className="max-w-[540px]">
            <DialogHeader>
              <DialogTitle>{asset}</DialogTitle>
              <DialogDescription className="text-center">
                Performance {getDescription(time)}
              </DialogDescription>
            </DialogHeader>
